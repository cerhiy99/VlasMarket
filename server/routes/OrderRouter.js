...
router.post('/fastOrder', OrderController.NewFastOrder);
//router.post('/setOrder', OrderController.SetOrder);
router.post('/setOrder', OrderController.SetNewOrder);
...
router.get(
  '/getOrdersMeneger',
  IsMenegerMiddleWare,
  OrderController.GetOrdersMeneger
);
...
router.get(
  '/getProductToOrder',
  IsMenegerMiddleWare,
  OrderController.GetProductToOrder
);
...
router.get(
  '/userGetCountYoutBonus',
  IsAuthMiddleWare,
  OrderController.getCountUserBonnus
);
router.get('/getBonusFull', IsAuthMiddleWare, OrderController.GetBonusFull);
