...
const page = async ({ params }: Props) => {
  ...
  const info = {
    ru: `Сайт <a href='https://vlasmarket.com.ua/'>https://https://vlasmarket.com.ua/</a>: продавец — физическое лицо-предприниматель Лаптев Влас Валерьевич (ИНН 2486120076), юридическое лицо, созданное и действующее в соответствии с действующим законодательством Украины, местонахождение которого: 62480, Харьковская обл., Харьковский р-н, село Хроли, ул. Гагарина, дом 6.`,
    ua: `Сайт <a href='https://vlasmarket.com.ua/'>https://https://vlasmarket.com.ua/</a>: продавець – Фізична особа підприємець Лаптєв Влас Валерійович (ІПН 2486120076), юридична особа, яка створена і діє відповідно до чинного законодавства України, місцезнаходження якої: 62480, Харківська обл. Харківський р-он, село Хролі, вул. Гагаріна будинок 6.`,
  };
  return (
