...
import './AboutUs.scss';
import FormCooperation from '@/app/[lang]/(basic-layout)/cooperation/FormCooperation';
...
export async function generateMetadata({ params }: Props) {
  ...
  const titles = {
    ua: 'Про магазин — VlasMarket',
    ru: 'О магазине — VlasMarket',
  };

  const descriptions = {
    ua: 'Дізнайтесь більше про інтернет-магазин VlasMarket. Наша історія, цінності та мета.',
    ru: 'Узнайте больше об интернет-магазине VlasMarket. Наша история, ценности и цель.',
  };
